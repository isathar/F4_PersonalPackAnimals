...
Scriptname PersonalPAckAnimals:Fragments:TIF_PackAnimalManager_Trade_1 Extends TopicInfo Hidden Const
...
;END AUTOCAST
;BEGIN CODE
kmyQuest.PackAnimalAction_Trade(akSpeaker.GetDialogueTarget())
;END CODE
EndFunction
;END FRAGMENT
