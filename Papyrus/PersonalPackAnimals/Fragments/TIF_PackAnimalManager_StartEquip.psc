...
Scriptname PersonalPAckAnimals:Fragments:TIF_PackAnimalManager_StartEquip Extends TopicInfo Hidden Const
...
;END AUTOCAST
;BEGIN CODE
kmyQuest.PlacePackAnimalEquipBench(akSpeaker.GetDialogueTarget())
;END CODE
EndFunction
;END FRAGMENT
