...
Scriptname PersonalPAckAnimals:Fragments:TIF_PackAnimalManager_Wait_1 Extends TopicInfo Hidden Const
...
;END AUTOCAST
;BEGIN CODE
kmyQuest.CommandPackAnimal_WaitHere(akSpeaker.GetDialogueTarget())
;END CODE
EndFunction
;END FRAGMENT
