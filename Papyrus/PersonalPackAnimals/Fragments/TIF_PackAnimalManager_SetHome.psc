...
Scriptname PersonalPAckAnimals:Fragments:TIF_PackAnimalManager_SetHome Extends TopicInfo Hidden Const
...
;END AUTOCAST
;BEGIN CODE
kmyQuest.PackAnimalAction_SetHome(akSpeaker.GetDialogueTarget())
;END CODE
EndFunction
;END FRAGMENT
