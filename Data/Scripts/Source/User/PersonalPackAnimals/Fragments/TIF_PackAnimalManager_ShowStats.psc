...
Scriptname PersonalPAckAnimals:Fragments:TIF_PackAnimalManager_ShowStats Extends TopicInfo Hidden Const
...
;END AUTOCAST
;BEGIN CODE
kmyQuest.PackAnimalAction_ShowStats(akSpeaker.GetDialogueTarget())
;END CODE
EndFunction
;END FRAGMENT
