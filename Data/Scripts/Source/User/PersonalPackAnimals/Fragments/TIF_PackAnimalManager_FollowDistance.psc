...
Scriptname PersonalPAckAnimals:Fragments:TIF_PackAnimalManager_FollowDistance Extends TopicInfo Hidden Const
...
;END AUTOCAST
;BEGIN CODE
kmyQuest.PackAnimalAction_SetFollowDistance(akSpeaker.GetDialogueTarget())
;END CODE
EndFunction
;END FRAGMENT
