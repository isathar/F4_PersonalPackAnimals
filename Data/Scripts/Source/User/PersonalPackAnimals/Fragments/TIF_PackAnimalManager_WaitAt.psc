...
Scriptname PersonalPAckAnimals:Fragments:TIF_PackAnimalManager_WaitAt Extends TopicInfo Hidden Const
...
;END AUTOCAST
;BEGIN CODE
kmyQuest.CommandPackAnimal_WaitAt(akSpeaker.GetDialogueTarget())
;END CODE
EndFunction
;END FRAGMENT
