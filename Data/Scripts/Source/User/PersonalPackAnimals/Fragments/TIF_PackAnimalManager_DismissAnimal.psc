...
Scriptname PersonalPAckAnimals:Fragments:TIF_PackAnimalManager_DismissAnimal Extends TopicInfo Hidden Const
...
;END AUTOCAST
;BEGIN CODE
kmyQuest.CommandPackanimal_Dismiss(akSpeaker)
;END CODE
EndFunction
;END FRAGMENT
