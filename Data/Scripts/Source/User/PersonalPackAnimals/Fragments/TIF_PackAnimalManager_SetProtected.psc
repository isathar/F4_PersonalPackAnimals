...
Scriptname PersonalPAckAnimals:Fragments:TIF_PackAnimalManager_SetProtected Extends TopicInfo Hidden Const
...
;END AUTOCAST
;BEGIN CODE
kmyQuest.PackAnimalAction_SetProtected(akSpeaker.GetDialogueTarget())
;END CODE
EndFunction
;END FRAGMENT
